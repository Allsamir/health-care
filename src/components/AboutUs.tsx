...
const AboutUs = () => {
  return (
    <div className="flex lg:flex-row flex-col gap-4 my-40" id="about-us">
      <TextContainer
      ...
      <div className="relative flex-1 lg:mt-0 mt-8">
        ...
        <div className="max-w-[24.6875rem] py-11 px-7 bg-[#343268] rounded-[2rem] absolute lg:-left-24 left-0 lg:bottom-0 -bottom-16">
